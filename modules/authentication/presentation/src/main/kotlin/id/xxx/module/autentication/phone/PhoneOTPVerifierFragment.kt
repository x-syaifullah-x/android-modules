                ...
                viewLifecycleOwner.lifecycleScope.launch {
                    ...
                    val type =
                        if (a is FromSignupPhoneFragment)
                            AuthMethod.Phone(mode = AuthMethod.Mode.UP, verificationId = verificationId, code = code)
                        else
                            AuthMethod.Phone(mode = AuthMethod.Mode.IN, verificationId = verificationId, code = code)
