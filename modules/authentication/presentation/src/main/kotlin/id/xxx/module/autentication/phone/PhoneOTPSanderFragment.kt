...
class PhoneOTPSanderFragment : Fragment() {
    ...
    private val onBackPressedCallback = object : OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
            ...
            val args = bundleOf(PhoneFragment.DATA_EXTRA_PHONE_NUMBER to phoneNumber)
            sfm.beginTransaction().replace(id, PhoneFragment::class.java, args).commit()
        }
    }
            ...
            fun onSend(response: String) {
                ...
                try {
                    ...
                    requireActivity().supportFragmentManager.beginTransaction()
                        .replace(id, PhoneOTPVerifierFragment::class.java, args, null)
                        .commit()
                } catch (t: Throwable) {
...
//                    val errCode = err.getString("code")
                    ...
                    val args = bundleOf(
                        PhoneFragment.DATA_EXTRA_PHONE_NUMBER to phoneNumber,
                        PhoneFragment.DATA_EXTRA_MESSAGE_ERROR to errMessage
                    )
                    requireActivity().supportFragmentManager.beginTransaction()
                        .replace(id, PhoneFragment::class.java, args, null)
                        .commit()
                }
            }
